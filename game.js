...
async function initGamePage() {
    ...
    animateCounter(document.getElementById('statTotal'), allGames.length);
    animateCounter(document.getElementById('statSolo'), soloCount);
    animateCounter(document.getElementById('statMulti'), multiCount);
